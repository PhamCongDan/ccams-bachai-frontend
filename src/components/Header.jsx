        ...
        <div className="flex gap-2">
          <div className="w-36">
            <SelectBox name="Menu" value={activeUnit} nonSelected>
              <SelectBoxItem name='Tra cứu đi lễ' value='' changeSelection={changeUnit} />
              <SelectBoxItem name='Tìm kiếm' value='search' changeSelection={changeUnit} />
              {isNganhAu && <SelectBoxItem name='Cấp lại thẻ' value='request-card' changeSelection={changeUnit} />}
            </SelectBox>
          </div>
        </div>
      </header>
